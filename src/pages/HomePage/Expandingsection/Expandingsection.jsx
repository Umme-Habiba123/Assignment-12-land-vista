  ...
  return (
    <section className="bg-gray-800 text-white py-16 px-6 md:px-20 overflow-hidden">
      ...
      <h2 className="text-center text-3xl md:text-5xl font-light tracking-widest mb-10">
        EXPANDING THE <span className="text-pink-500">HORIZON</span>
      </h2>
      ...
      <div className="grid md:grid-cols-2 gap-10 items-center">
        ...
        <div className="flex flex-col gap-10">
          <div className="grid grid-cols-2 gap-8 text-center">
            <div>
              <h3 className="text-pink-500 text-5xl font-bold">28+</h3>
              <p className="text-gray-300 mt-2">Years Of Experience</p>
            </div>
            <div>
              <h3 className="text-pink-500 text-5xl font-bold">235+</h3>
              <p className="text-gray-300 mt-2">Projects Completed</p>
            </div>
            <div>
              <h3 className="text-pink-500 text-5xl font-bold">4500+</h3>
              <p className="text-gray-300 mt-2">Units Delivered</p>
            </div>
            <div>
              <h3 className="text-pink-500 text-5xl font-bold">1300+</h3>
        ...
        <div className="relative">
          <img
            src="https://i.ibb.co.com/Wv7hyTDn/5-esplanade-hero-min.jpg"
            alt="Luxury interior"
